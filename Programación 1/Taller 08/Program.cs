namespace Taller_08
{
    ...
    {
        public static double Precio (int costoFun , int gananciaFun) 
        {
            double precioFin = (costoFun * 100) / (100 - gananciaFun); //operaciones para determinar el precio con un % de ganancia sobre el monto de venta 
            return precioFin;
        }
